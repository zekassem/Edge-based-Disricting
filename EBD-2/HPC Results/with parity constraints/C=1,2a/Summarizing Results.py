...
with open('Results/Summary_1st_Logic_2nd_w_z.csv', 'w') as newFile:
    ...
    for prob in probs:
        ...
        for num in no_dist:
            for t in tol:
                for t_2 in tol_2:
                    results_file = '1st_logic_w_z_no_dist_'+str(num)+'_tol_'+str(t)+'_tol_2_'+str(t_2)+'_prob_'+str(prob)+'.csv'

...
tol=[0.10]# tolerance parameter into the balancing constraints
...
for prob in probs:
    ...
    for num in no_dist:
        for t in tol:
            ...
            with open('Results/1st_Logic_2nd_w_z_no_dist_'+str(num)+'_tol_'+str(t)+'_prob_'+str(prob)+'.csv','w') as newFile:

...
no_dist=[10,2] # the number of districts
tol=[0.01]# tolerance parameter into the balancing constraints
...
for prob in probs:
    ...
    for num in no_dist:
        for t in tol:
            ...
            try:
                with open('Results/1st_Logic_2nd_wo_z_variables_no_dist_'+str(num)+'_tol_'+str(t)+'_prob_'+str(prob)+'.csv','w') as newFile:
